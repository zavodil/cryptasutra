...
{% hint style="danger" %}
Приведенные ниже названия `my_validator и owner`даны для примера. Обязательно исправляйте их на собственные названия. Не торопитесь: ошибки, допущенные в следующих шагах, потребует много часов на их исправление.
{% endhint %}
...
5. Отредактируйте файл ~/.near/betanet/validator\_key.json и впишите в поле account\_id название контракта стейкинг-пула. Остальные поля с ключами трогать не надо. Они не привязаны к какому-либо аккаунту, а относятся лишь к ноде.
