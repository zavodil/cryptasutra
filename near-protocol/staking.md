...
Теперь можно открыть стейкинг. Укажите accountId в полном виде \(например, `username.betanet`\), staking public key, который мы скопировали выше, а также размер стейкинга в токенах NEAR.
